...
console.log(`A soma dos números é de:`, soma(Number(prompt("Digite um número")), Number(prompt("Digite um segundo número"))))
...
maiorOuIgual(Number(prompt("Informe o primeiro número:")), Number(prompt("Informe o segundo número:")))
...
console.log("O valor com deconto vai ser de:", number - inss(number))
