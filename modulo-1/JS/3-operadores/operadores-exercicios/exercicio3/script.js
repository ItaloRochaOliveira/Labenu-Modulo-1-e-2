...
const dataDeNascimento = prompt(
  `Olá ${nome} qual a data do seu nascimento? (não esqueça de usar /, como 12/12/2022`
);
...
console.log(
  "Sua porcentagem de comissão nesses ultimos 6 meses é de:",
  porcentagemPorComissao
);
