<<<<<<< HEAD:modulo-1/JS/3-operadores/operadores-exercicios/exercicio2/script.js
// # Exercício 2
...
console.log("Seu primeiro número é divisivel pelo segundo?", number1 % number2, `\n (se ele for 0 é sim, se 1, não)`)
// O segundo numero é divisível pelo primeiro? true
console.log("Seu secundo número é divisivel pelo primeiro?", number2 % number1, `\n (se ele for 0 é sim, se 1, não)`)
=======
// # Exercício 2
...
>>>>>>> origin/exercicio-operadores-para-feedback:modulo-1/operadores/operadores-exercicios/exercicio2/script.js
